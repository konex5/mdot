...
using menv_index_t = std::tuple<index_t, index_small_t, index_t, index_t,
                                index_small_t, index_t>;
using menv_shape_t = std::tuple<index_t, index_small_t, index_t, index_t,
                                index_small_t, index_t>;
