...
template <class Q> struct real_sh_operators_crtp {
  ...
  inline static constexpr std::array<dnum_t, 4> times(const dnum_t alpha) {
    return {alpha * Q::n_array[0], alpha * Q::n_array[1], alpha * Q::n_array[2],
            alpha * Q::n_array[3]};
  }
  inline static constexpr std::array<znum_t, 4> times(const znum_t alpha) {
    return {alpha * Q::n_array[0], alpha * Q::n_array[1], alpha * Q::n_array[2],
            alpha * Q::n_array[3]};
  }
  inline static constexpr dnum_t trace() {
    return Q::n_array[0] + Q::n_array[3];
  };
  inline static constexpr std::array<dnum_t, 4> square() {
    return {Q::n_array[0] * Q::n_array[0] + Q::n_array[1] * Q::n_array[2],
...
template <class Q> struct cplx_sh_operators_crtp {
  static constexpr index_t size = Q::n_size;
  static constexpr std::array<index_t, 2> shape = Q::n_shape;
  static constexpr std::array<znum_t, 4> array = Q::n_array;

  inline static constexpr std::array<znum_t, 4> times(const dnum_t alpha) {
    return {alpha * Q::n_array[0], alpha * Q::n_array[1], alpha * Q::n_array[2],
            alpha * Q::n_array[3]};
  }
  inline static constexpr std::array<znum_t, 4> times(const znum_t alpha) {
  ...
  inline static constexpr znum_t trace() {
    return Q::n_array[0] + Q::n_array[3];
  };
  inline static constexpr std::array<znum_t, 4> square() {
    return {Q::n_array[0] * Q::n_array[0] + Q::n_array[1] * Q::n_array[2],
            Q::n_array[0] * Q::n_array[1] + Q::n_array[1] * Q::n_array[3],
            Q::n_array[2] * Q::n_array[0] + Q::n_array[3] * Q::n_array[2],
            Q::n_array[2] * Q::n_array[1] + Q::n_array[3] * Q::n_array[3]};
...
struct sh_id_no : real_sh_operators_crtp<sh_id_no> {
...
struct sh_id_cplx_no : cplx_sh_operators_crtp<sh_id_cplx_no> {
  static constexpr index_t n_size = 4;
  static constexpr std::array<index_t, 2> n_shape = {2, 2};
